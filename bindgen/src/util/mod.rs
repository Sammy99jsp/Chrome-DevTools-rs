...
use crate::protocol::modular::{AnyIdentifier, IntoAnyIdentifier, NamedIdentifier};
...
pub mod rust {
    ...
    /// ```
    ///
    pub fn self_ref(span: Span) -> syn::Type {
        syn::Type::Reference(syn::TypeReference {
            and_token: Default::default(),
            lifetime: None,
            mutability: None,
            elem: Box::new(syn::Type::Path(["Self"].map(to_ident(span)).to_type_path())),
        })
    }
